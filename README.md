...
| E2EE group chats | ❌ | ✅ | ⚠️ protocol done and tested, **no group screens yet** |
...
| Encrypted group chats with membership rotation | ⚠️ protocol done and tested; **no way to create or open one in the app** |
